namespace Full_EX
{
    partial class EX12
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // cb_Faculty (ComboBox chọn Khoa) - [Slide 92, 95]
            // 
            this.cb_Faculty.FormattingEnabled = true;
            // Thêm danh sách các Khoa vào Item giống Slide 95
            ...
            this.cb_Faculty.Name = "cb_Faculty"; // Tên biến trong Slide 92
            this.cb_Faculty.Size = new System.Drawing.Size(300, 28);
            this.cb_Faculty.TabIndex = 0;
            // Kết nối sự kiện chọn dòng (SelectedIndexChanged) - [Slide 96]
            ...
            // 
            // tbDisplay (Màn hình hiển thị kết quả)
            // 
            ...
            this.Name = "EX12";
            this.Text = "ComboBox Article 12";
            this.Load += new System.EventHandler(this.EX12_Load); // Sự kiện khi mở Form
